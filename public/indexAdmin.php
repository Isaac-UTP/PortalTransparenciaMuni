...
<body>
    ...
    <div class="content">
        <div class="mt-5">
            ...
            <div class="chart-container mt-4">
                <canvas id="documentUploadChart"></canvas>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const documentUploadCtx = document.getElementById('documentUploadChart').getContext('2d');
        const documentUploadChart = new Chart(documentUploadCtx, {
            type: 'line',
            data: {
